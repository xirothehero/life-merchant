...
public class TW_MultiStrings_Regular_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUI.changed)
        {
            EditorUtility.SetDirty(TW_MS_RegularScript);
        }
    }
}
#endif
...
public class TW_MultiStrings_Regular : MonoBehaviour {
    ...
    // Mine
    public bool StringDone()
    {
        return сharIndex >= ORIGINAL_TEXT.Length - 1;
    }

    // Mine, prevent looping
    public bool AllDone()
    {
        return index_of_string + 1 >= MultiStrings.Length;
    }
